        ...
        <div className="w-full max-w-[100rem] mx-auto px-5 sm:px-8 lg:px-12 xl:px-16 pt-16 pb-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-12 border-b border-white/10">
            <div className="lg:col-span-1">
              <Link to="/" className="inline-flex flex-col leading-none mb-5 group" aria-label="OPERAVA Global Solutions — Home">
                <div className="text-2xl font-black tracking-tight text-white group-hover:text-white/90 transition-colors">
                  {t('brand.name', 'OPERAVA')}
                </div>
                <div className="text-[10px] font-semibold tracking-[0.18em] text-white uppercase mt-0.5">
              ...
              <div>
                <div className="text-xs font-semibold tracking-wider uppercase text-white mb-3 flex items-center gap-2">
                  <span>Connect With Us</span>
                  <span className="text-[11px] text-white font-mono lowercase tracking-normal">@operavaglobal</span>
                </div>
                <div className="flex items-center gap-2.5 flex-wrap">
                  <a href="https://facebook.com/operavaglobal" target="_blank" rel="noopener noreferrer" aria-label="Follow OPERAVA on Facebook (@operavaglobal)" className="h-9 w-9 rounded-xl bg-white/5 border border-white/10 text-white hover:text-white hover:bg-[#1877F2] hover:border-[#1877F2] transition-all duration-200 flex items-center justify-center shadow-sm" title="Facebook (@operavaglobal)">
                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                  </a>
                  <a href="https://x.com/operavaglobal" target="_blank" rel="noopener noreferrer" aria-label="Follow OPERAVA on Twitter / X (@operavaglobal)" className="h-9 w-9 rounded-xl bg-white/5 border border-white/10 text-white hover:text-white hover:bg-black hover:border-white/40 transition-all duration-200 flex items-center justify-center shadow-sm" title="Twitter / X (@operavaglobal)">
                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                  </a>
                  <a href="https://tiktok.com/@operavaglobal" target="_blank" rel="noopener noreferrer" aria-label="Follow OPERAVA on TikTok (@operavaglobal)" className="h-9 w-9 rounded-xl bg-white/5 border border-white/10 text-white hover:text-white hover:bg-[#000000] hover:border-[#FE2C55] transition-all duration-200 flex items-center justify-center shadow-sm" title="TikTok (@operavaglobal)">
                  ...
                  <a href="https://instagram.com/operavaglobal" target="_blank" rel="noopener noreferrer" aria-label="Follow OPERAVA on Instagram (@operavaglobal)" className="h-9 w-9 rounded-xl bg-white/5 border border-white/10 text-white hover:text-white hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888] hover:border-transparent transition-all duration-200 flex items-center justify-center shadow-sm" title="Instagram (@operavaglobal)">
                  ...
                  <a href="https://linkedin.com/company/operavaglobal" target="_blank" rel="noopener noreferrer" aria-label="Follow OPERAVA on LinkedIn (@operavaglobal)" className="h-9 w-9 rounded-xl bg-white/5 border border-white/10 text-white hover:text-white hover:bg-[#0A66C2] hover:border-[#0A66C2] transition-all duration-200 flex items-center justify-center shadow-sm" title="LinkedIn (@operavaglobal)">
            ...
            <div>
              <h3 className="text-xs font-semibold tracking-[0.12em] uppercase text-white mb-4">{t('footer.legal', 'Legal')}</h3>
          ...
          <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 text-center sm:text-left">
              <p className="text-sm text-white">© 2026 OPERAVA Global Solutions. {t('footer.rights', 'All rights reserved.')}</p>
              <span className="hidden sm:inline text-white">•</span>
              <p className="text-xs text-white">{t('footer.location', 'Philippines • Global Operations')}</p>
            </div>
            <div className="flex items-center gap-3">
              <span className="text-xs font-medium text-white select-text">
