...
export default function Footer() {
  ...
  return (
    <>
      {/* ── DEPARTMENTAL EMAIL CONTACTS DIRECTORY (CAROUSEL) - WHITE BACKGROUND ── */}
          ...
          <div className="lg:col-span-1">
            ...
            <div>
              ...
              <div className="flex items-center gap-2.5 flex-wrap">
                {/* Facebook */}
                <a
                  href="https://facebook.com/operavaglobal"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Follow OPERAVA on Facebook (@operavaglobal)"
                  className="h-9 w-9 rounded-xl bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:bg-[#1877F2] hover:border-[#1877F2] transition-all duration-200 flex items-center justify-center group/soc shadow-sm"
                  title="Facebook (@operavaglobal)"
                >
                ...
                {/* Twitter / X */}
                <a
                  href="https://x.com/operavaglobal"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Follow OPERAVA on Twitter / X (@operavaglobal)"
                  className="h-9 w-9 rounded-xl bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:bg-black hover:border-white/40 transition-all duration-200 flex items-center justify-center group/soc shadow-sm"
                  title="Twitter / X (@operavaglobal)"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                {/* TikTok */}
                <a
                  href="https://tiktok.com/@operavaglobal"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Follow OPERAVA on TikTok (@operavaglobal)"
                  className="h-9 w-9 rounded-xl bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:bg-[#000000] hover:border-[#FE2C55] transition-all duration-200 flex items-center justify-center group/soc shadow-sm"
                  title="TikTok (@operavaglobal)"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                    <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64c.298-.002.595.042.88.13V9.4a6.33 6.33 0 0 0-1-.08A6.34 6.34 0 0 0 3 15.66a6.34 6.34 0 0 0 10.81 4.48 6.29 6.29 0 0 0 1.88-4.48V8.71a8.21 8.21 0 0 0 4.9 1.6V6.86c-.34-.03-.67-.09-1-.17z"/>
                  </svg>
                </a>

                {/* Instagram */}
                <a
                  href="https://instagram.com/operavaglobal"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Follow OPERAVA on Instagram (@operavaglobal)"
                  className="h-9 w-9 rounded-xl bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888] hover:border-transparent transition-all duration-200 flex items-center justify-center group/soc shadow-sm"
                  title="Instagram (@operavaglobal)"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                {/* LinkedIn */}
                <a
                  href="https://linkedin.com/company/operavaglobal"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Follow OPERAVA on LinkedIn (@operavaglobal)"
                  className="h-9 w-9 rounded-xl bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:bg-[#0A66C2] hover:border-[#0A66C2] transition-all duration-200 flex items-center justify-center group/soc shadow-sm"
                  title="LinkedIn (@operavaglobal)"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
