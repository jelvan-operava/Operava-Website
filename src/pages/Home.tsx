      ...
      <main className={`overflow-x-hidden transition-opacity duration-700 ${isHomeReady ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <section ref={workforceRef} className="py-20 lg:py-28 bg-violet-700 text-white overflow-hidden relative">
          <div className="absolute inset-0 opacity-20 pointer-events-none" aria-hidden="true">
            ...
            <div className="absolute -bottom-24 -left-24 w-96 h-96 rounded-full bg-fuchsia-300/30 blur-3xl" />
          </div>
          <div className="relative w-full max-w-[100rem] mx-auto px-5 sm:px-8 lg:px-12 xl:px-16 grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-xs font-bold tracking-[0.18em] uppercase text-violet-200 mb-3">Global Workforce</p>
              ...
              <p className="text-base text-violet-100 leading-relaxed mb-6 max-w-xl">
                Dedicated professionals and managed teams supporting technology delivery, customer operations, and business processes across time zones.
              </p>
              <Link
                to="/careers"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white text-violet-800 font-semibold text-sm hover:bg-violet-50 transition-colors"
              >
                <span>Explore talent opportunities</span>
                <ArrowRight className="w-4 h-4" />
              </Link>
            </div>
            <div className="flex justify-center">
              <img
                src="https://res.cloudinary.com/sdaxzncs/image/upload/global_workforce_FULLY_TRANSPARENT_ghnan4.png"
        ...
        <section ref={techRef} className="py-20 lg:py-28 bg-[#F7F6F4]">
          <div className="w-full max-w-[100rem] mx-auto px-5 sm:px-8 lg:px-12 xl:px-16">
            <div className="max-w-2xl mb-10">
              <h2 className="reveal text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 tracking-tight leading-tight">
                Technology stacks and operating capabilities
              </h2>
              <p className="reveal reveal-delay-1 text-base text-gray-500 mt-3">
                Core platforms and disciplines that power OPERAVA delivery across software, infrastructure, and operations.
              </p>
            </div>
            <div className="reveal reveal-delay-2 flex flex-wrap gap-3">
        ...
        <section ref={whyRef} className="py-24 lg:py-32 bg-[#FBFBFA] relative overflow-hidden">
          <div className="w-full max-w-[100rem] mx-auto px-5 sm:px-8 lg:px-12 xl:px-16 relative z-10">
            <div className="text-center max-w-2xl mx-auto mb-14">
              ...
              <p className="reveal reveal-delay-1 text-base text-gray-500 mt-3">
                Six principles that shape how OPERAVA designs technology, teams, and processes for lasting outcomes.
              </p>
            </div>

            <div className="relative mx-auto w-full max-w-lg aspect-square flex items-center justify-center">
              <div className="absolute inset-[18%] rounded-full border border-violet-100" />
              <div className="absolute inset-[32%] rounded-full border border-violet-50" />
              <div className="relative z-20 w-[42%] aspect-square rounded-full bg-white border border-violet-100 shadow-lg flex flex-col items-center justify-center text-center p-4">
                <p className="text-sm sm:text-base font-bold text-gray-900 leading-snug">{whyFeaturesList[whySlide].title}</p>
                <p className="mt-2 text-[11px] sm:text-xs text-gray-500 leading-relaxed">{whyFeaturesList[whySlide].desc}</p>
              </div>
              {whyFeaturesList.map((f, i) => {
                const n = whyFeaturesList.length
                const rel = (i - whySlide + n) % n
                ...
                return (
                  <button
                    ...
                    className={`absolute w-16 h-16 sm:w-20 sm:h-20 -translate-x-1/2 -translate-y-1/2 rounded-full border flex items-center justify-center text-center transition-all duration-500 ${
                      isActive
                        ? 'bg-violet-700 text-white border-violet-700 scale-110 shadow-lg shadow-violet-700/30'
        ...
        <section ref={signatureRef} className="pt-0 pb-6 sm:pb-8 bg-[#FBFBFA] relative overflow-hidden">
