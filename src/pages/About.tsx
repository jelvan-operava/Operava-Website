...
export default function About() {
  ...
  return (
    <main className="bg-[#FBFBFA]">
      <section className="pt-28 pb-16 lg:pt-36 lg:pb-24 bg-gradient-to-b from-[#F7F6F4] via-[#FBFBFA] to-[#FBFBFA] border-b border-stone-100/80">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {complianceHighlights.map((item, idx) => (
              ...
              >
                ...
                <p className="text-xs font-semibold text-violet-700 mb-2">{item.authority}</p>
                <p className="text-sm text-gray-600 leading-relaxed">{item.desc}</p>
              </div>
            ))}
          </div>
        ...
        <div className="w-full max-w-[100rem] mx-auto px-5 sm:px-8 lg:px-12 xl:px-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-violet-500/30 transition-all">
              <h3 className="text-xl font-bold text-violet-300 mb-4">For Businesses & Organizations</h3>
              <ul className="space-y-3.5 text-sm text-gray-300">
                <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-violet-400 shrink-0 mt-0.5" /><span>Access to a broader, vetted pool of skilled technology and operational talent.</span></li>
                <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-violet-400 shrink-0 mt-0.5" /><span>Greater staffing flexibility without the constraints of physical office footprints.</span></li>
                <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-violet-400 shrink-0 mt-0.5" /><span>Scalable operational capacity that adjusts dynamically with business cycles.</span></li>
                <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-violet-400 shrink-0 mt-0.5" /><span>Faster onboarding, extended service coverage, and business continuity.</span></li>
              </ul>
            </div>
            <div className="p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-violet-500/30 transition-all">
              <h3 className="text-xl font-bold text-blue-300 mb-4">For Professionals & Teams</h3>
              <ul className="space-y-3.5 text-sm text-gray-300">
                <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0 mt-0.5" /><span>Access to international opportunities beyond immediate geographic proximity.</span></li>
                <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0 mt-0.5" /><span>Elimination of daily commuting burdens, promoting work-life balance and focus.</span></li>
                <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0 mt-0.5" /><span>Exposure to modern global tech stacks, SaaS tools, and business workflows.</span></li>
                <li className="flex items-start gap-2.5"><CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0 mt-0.5" /><span>Clear merit-based career progression and structured skills development.</span></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 lg:py-24 bg-[#FBFBFA]">
        <div className="w-full max-w-[100rem] mx-auto px-5 sm:px-8 lg:px-12 xl:px-16">
          ...
          <div className="p-8 rounded-2xl bg-gradient-to-r from-violet-900 to-indigo-900 text-white flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h3 className="text-2xl font-bold mb-2">Join Our Growing Global Workforce</h3>
      ...
      <section className="py-16 lg:py-24 bg-[#F7F6F4] border-t border-stone-100/80">
        <div className="w-full max-w-[100rem] mx-auto px-5 sm:px-8 lg:px-12 xl:px-16">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 px-8 py-3.5 text-sm font-semibold text-white bg-violet-700 rounded-xl hover:bg-violet-800 transition-colors"
            >
              Get in Touch Today
              <ArrowRight className="w-4 h-4" />
            </Link>
